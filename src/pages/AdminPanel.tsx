  ...
  const [services, setServices] = useState<Service[]>([
    {
      id: 1,
      title: 'Интернет',
      description: 'Высокоскоростной интернет до 1 Гбит/с',
      price: '500 ₽/мес',
      icon: 'Wifi',
      features: ['До 1 Гбит/с', 'Безлимитный трафик', 'Статический IP']
    },
    {
      id: 2,
      title: 'Телевидение',
      description: '200+ каналов в HD качестве',
      price: '300 ₽/мес',
      icon: 'Tv',
      features: ['200+ каналов', 'HD качество', 'Архив передач']
    }
  ]);
